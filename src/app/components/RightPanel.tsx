  ...
  return (
    <div className="flex flex-col">
      ...
      <button
        ...
        onClick={() => setOpen(p => !p)}
        className={`w-full flex items-center gap-3 px-3.5 py-3 rounded-xl text-left transition-all duration-200 cursor-pointer border group ${open
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className={`text-[13px] font-extrabold leading-tight truncate transition-colors ${open ? '' : (dk ? 'text-slate-300' : 'text-slate-700')
        ...
        <div className="ml-5 mt-1.5 mb-2.5 flex flex-col gap-1.5" style={{ borderLeft: `2px solid ${glow}40`, paddingLeft: '12px' }}>
          {schools.map((school, si) => (
            <div
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-150 ${dk
  ...
  return (
    <>
      ...
      >
        ...
        <div className="xl:hidden w-12 h-1 bg-slate-300 dark:bg-slate-700 rounded-full mx-auto mt-3.5 mb-1.5 flex-shrink-0" />
      ...
      ══════════════════════════════════════════ */}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          >
                            ...
                            {(m as any).isUnverified && (
                              <span className={`inline-flex items-center px-1.5 py-0.5 rounded text-[8px] font-black uppercase tracking-wider ${dk
                          ...
                          <div
                            ...
                            style={{ color: isActive ? (dk ? '#fff' : ac.hex) : (dk ? '#2188f0ff' : '#0f172a') }}
                          >
        ...
        ══════════════════════════════════════════ */}
          <div className="flex flex-col pb-6">
            ...
            {/* ── Section Banner ── */}
            <div className={`relative overflow-hidden mx-4 mt-4 mb-3 rounded-2xl p-4 border ${dk ? 'border-purple-500/20 bg-gradient-to-br from-purple-900/30 via-[#1a0f2e]/60 to-indigo-900/20'
              ...
              <div className="relative z-10">
                ...
                >
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-[10px] font-extrabold uppercase tracking-wider transition-all duration-200 cursor-pointer ${activeTab === 'schools'
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg text-[10px] font-extrabold uppercase tracking-wider transition-all duration-200 cursor-pointer ${activeTab === 'tntet'
              ...
              <div className="px-4">
                {schoolsLoading ? (
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    {/* Summary pill */}
                    <div className={`mt-1 flex items-center justify-center gap-3 py-3 rounded-2xl border border-dashed ${dk ? 'border-slate-800/60' : 'border-slate-200'
                      }`}>
                  ...
                  <div className={`relative overflow-hidden flex flex-col items-center justify-center py-10 rounded-2xl border border-dashed text-center ${dk ? 'bg-[#1e293b]/20 border-slate-800/50' : 'bg-white border-slate-200'
                    }`}>
                    <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-transparent pointer-events-none rounded-2xl" />
                    <div className={`relative w-14 h-14 rounded-2xl flex items-center justify-center mb-4 ${dk ? 'bg-[#1e293b] border border-slate-800' : 'bg-purple-50 border border-purple-100'
                      }`}>
            ...
            {activeTab === 'tntet' && (() => {
              ...
              return (
                <div className="px-4 pb-6 flex flex-col gap-3">
                  ...
                  <div className={`p-3.5 rounded-2xl border flex items-start gap-3 ${dk ? 'bg-amber-500/10 border-amber-500/30 text-amber-200' : 'bg-amber-50 border-amber-200 text-amber-900'
                    }`}>
                  ...
                  <div className="grid grid-cols-1 gap-2.5 mt-1">
                    ...
                    <div className={`p-4 rounded-2xl border flex items-center justify-between ${dk ? 'bg-[#1e293b]/60 border-slate-700/50' : 'bg-slate-50 border-slate-200'
                      }`}>
                      <div>
                    ...
                    <div className={`p-3.5 rounded-2xl border flex items-center justify-between ${dk ? 'bg-indigo-950/30 border-indigo-800/30' : 'bg-indigo-50/50 border-indigo-100'
                      }`}>
